             ...
             <div class="px-4 py-3 mb-8 bg-white rounded-lg shadow-md dark:bg-gray-800">
                 ...
                 <form action="{{ url('update-stock/' . $stock->id) }}" method="POST" enctype="multipart/form-data">
                     ...
                     <select
                         ...
                         @error('product_name') is-invalid @enderror" name="product_name" id="product_name">
                     ...
                     <input type="number" name="count" value="{{ $stock->count }}"
                         class="  block w-full mt-1 text-sm border-green-600 dark:text-gray-300 dark:bg-gray-700 focus:border-green-400 focus:outline-none focus:shadow-outline-green form-input" />
                     ...
                     <select
                         class="block w-full mt-1 text-sm border-green-600 dark:text-gray-300 dark:bg-gray-700 focus:border-green-400 focus:outline-none focus:shadow-outline-green form-input"
                         @error('brand_name') is-invalid @enderror" name="brand_name" id="brand_name">
                     ...
                     <input type="text" name="specification" value="{{ $stock->specification }}"
                         class="  block w-full mt-1 text-sm border-green-600 dark:text-gray-300 dark:bg-gray-700 focus:border-green-400 focus:outline-none focus:shadow-outline-green form-input" />
                     ...
                     <input type="text" name="description" value="{{ $stock->description }}"
                         class="  block w-full mt-1 text-sm border-green-600 dark:text-gray-300 dark:bg-gray-700 focus:border-green-400 focus:outline-none focus:shadow-outline-green form-input" />
