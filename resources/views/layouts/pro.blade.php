 ...
 <head>
     ...
     <script src="{{ asset('asset/js/charts-lines.js') }}" defer></script>
         ...
         <div class="flex flex-col flex-1">
             <header class="z-10 py-4 bg-white shadow-md dark:bg-gray-800">
                 <div
                     ...
                     <!-- Search input -->
                     <form class="flex justify-center flex-1 lg:mr-32" type="get" action="{{ url('search') }}">
                         <div class="relative w-full max-w-xl mr-6 focus-within:text-purple-500">
                             ...
                             <input
                                 ...
                                 name="query" type="text" placeholder="Search for products"
                                 aria-label="Search" />
                         </div>
                     </form>
